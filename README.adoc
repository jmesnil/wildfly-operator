...
[NOTE]
=====
It is based on the S2I application image https://quay.io/repository/jmesnil/wildfly-operator-quickstart[jmesnil/wildfly-operator-quickstart:17.0] that provides a simple Java Web application https://github.com/jmesnil/wildfly-operator-quickstart[wildfly-operator-quickstart] on top of WildFly 17.0.0.Final which returns the IP address of its host:
...
Spec:
  Application Image:  quay.io/jmesnil/wildfly-operator-quickstart:17.0
  Size:               2
  Storage:
